...
const hayProductosMillonarios = productos.some(
    producto => producto.precio > 1000000
);
console.log("¿Hay productos con precio mayor a $1.000.000?", hayProductosMillonarios);
...
console.log("¿Todos tienen stock válido?", stocksValidos);
